    ...
    <section id="hero" className="hero">
      ...
      <div className="hero-content container reveal">
        <div className="hero-simple-content">
          <h1 className="hero-simple-title">DEVIL STUDIO</h1>
          <p className="hero-simple-subtitle">Professional Photography & Cinema</p>
          
          <div className="hero-simple-actions">
            <a href="#contact" className="btn-primary">Book Now</a>
            <a href="#portfolio" className="btn-outline">Portfolio</a>
          </div>
        </div>
      </div>
